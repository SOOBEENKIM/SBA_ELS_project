...
![원본 조건 HV·IV 비교](analysis/ppt_reference_20260915/figures/recomputed_hv_iv_segments.png)
...
전체 설정·표·민감도·예측 그림은 [실험 보고서](analysis/ppt_reference_20260915/REPORT.md), 데이터부터 다시 실행하거나 저장된 결과로 그림만 만드는 방법은 [실행 안내](analysis/ppt_reference_20260915/EXECUTION.md)에 있다.
...
| 지표 | A: NS·HV120·무배당 | B: 부트스트랩·EWMA120·이산배당 |
|---|---|---|
| 공정가−MC 평균 (원) | -559.3995 | -427.1318 |
| MAE (원) | 634.8140 | 566.7856 |
| RMSE (원) | 747.2189 | 681.4637 |
| MAPE (%) | 7.0222 | 6.2535 |
| 차이의 표준편차 (원) | 495.3913 | 530.9953 |

| 모델 | 사양 | 노트북 R² | 재실행 R² 평균 ± SD | 노트북 MAPE (%) | 재실행 MAPE (%) 평균 ± SD |
|---|---|---|---|---|---|
| deeponet | A | 0.9305 | 0.9340 ± 0.0432 | 0.4192 | 0.4184 ± 0.1032 |
| deeponet | B | 0.9468 | 0.9465 ± 0.0099 | 0.5440 | 0.5427 ± 0.0719 |
| xgb | A | 0.9041 | 0.9033 ± 0.0020 | 0.5854 | 0.5927 ± 0.0057 |
| xgb | B | 0.9155 | 0.9166 ± 0.0007 | 0.7037 | 0.6995 ± 0.0046 |
